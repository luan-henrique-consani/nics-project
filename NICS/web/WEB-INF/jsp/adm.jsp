                    ...
                    <tbody>
                        ...
                        <c:forEach items="${usuario}" var="usuarios">
                            <tr class="linha-contagem">
                                <th scope="col" id="data-idusuario">${usuarios.idUsuario}</th>
                                <td class="usuNome">${usuarios.nome}</td>
                                <td class="usuEmail">${usuarios.email}</td>
                                <td class="usuTel">${usuarios.telefone}</td>
                                <td class="usuCpf">${usuarios.cpf}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </div>
            ...
            <table class="table">
                ...
                <div class="tabelacorpo">
                    <tbody>
                        ...
                        <c:forEach items="${estoque2}" var="estoques">
                            <tr class="linha-contagem">
                                <th scope="col" id="data-idestoque">${estoques.idEstoque}</th>
                                <td class="estQtdValue">${estoques.quantidade}</td>
                                <td class="estVarValue">${estoques.variacao}</td>
                ...
                <div class="tabelacorpo">
                    <tbody>
                        <c:forEach items="${categoria}" var="categorias">
                            <tr class="linha-contagem">
                                <th scope="col" id="data-idcategoria">${categorias.iCategoria}</th>
                                <td class="catValue">${categorias.nomeCategoria}</td>
                        <form action="deletar-produtos" enctype="multipart/form-data" method="post">
                            <input type="hidden" value="${categorias.iCategoria}" name="id">
                    ...
                    <tbody>
                        <c:forEach items="${produto}" var="produtos">
                            <tr class="linha-contagem">
                                ...
                                <td class="preValue"><fmt:formatNumber value="${carrinhos.preco}" type="currency"/></td>
                        <form action="deletar-produtos" enctype="multipart/form-data" method="post">
