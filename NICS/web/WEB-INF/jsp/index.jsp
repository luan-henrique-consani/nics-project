    ...
    <head>
        ...
        <c:forEach items="${produto}" var="produtos">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="data:image/png;base64,${produtos.imgBase64}" alt="${produtos.nomeProdutos}">
                <div class="card-body">
                    <h5 class="card-title">${produtos.nomeProdutos}</h5>
                    <a href="./produtoUni?id=${produtos.idProdutos}" class="btn btn-primary">Comprar</a>
                </div>
            </div>
        </c:forEach>

        <a href="./cad-prt">cad</a>
    </main>
